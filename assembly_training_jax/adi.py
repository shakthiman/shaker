...
def main ():
  ...
  encoder_params, conditioner_params, decoder_params = model_loading.LoadModel(
          ...
          blob_name='assembly_based_jax_adi_reduced_saving5/177000',
  ...
  model_trainer.Train(
    ...
    model_save_blob='assembly_based_jax_adi_reduced_saving6',
    tensorboard_target='gs://variational_shaker_models/tensorboard/assembly_based_jax_adi_reduced_saving6',
