...
def main ():
  ...
  model_trainer.Train(
    ...
    model_save_blob='assembly_based_jax_adi_reduced_saving3',
    tensorboard_target='gs://variational_shaker_models/tensorboard/assembly_based_jax_adi_reduced_saving3',
