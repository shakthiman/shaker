...
def main ():
  ...
  vae_params = model_loading.LoadModelV2(
      ...
      blob_name='assembly_based_jax_mahat_fixed_loss8/500000',
  ...
  model_trainer_v2.Train(
    ...
    model_save_blob='assembly_based_jax_mahat_fixed_loss9',
    tensorboard_target='gs://variational_shaker_models/tensorboard/assembly_based_jax_mahat_fixed_loss9',
    vae=vae,
    optimizer=optimizer,
    vae_params=vae_params,
    opt_state=opt_state,
