...
def main ():
  ...
  model_trainer_v2.Train(
    ...
    model_save_blob='assembly_based_jax_mahat_consider_dihedral_loss10_fix_lower_dihedral_weight',
    tensorboard_target='gs://variational_shaker_models/tensorboard/assembly_based_jax_mahat_consider_dihedral_loss10_fix_lower_dihedral_weight',
    vae=vae,
    optimizer=optimizer,
    vae_params=vae_params,
    opt_state=opt_state,
