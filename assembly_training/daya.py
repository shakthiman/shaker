...
from protein_folding.variational_model.models import sequence_latent_space_with_hierarchical_precise_encoder
...
def main ():
  ...
  with strategy.scope():
    variational_model = sequence_latent_space_with_hierarchical_precise_encoder.MODEL_FOR_TRAINING(
        v, config)
  ...
  model_trainer.Train(
    ...
    optimizer=optimizer,
    save_frequency=1000,
    write_target='gs://variational_shaker_models/assembly_based_model_prod_daya3',
    tensorboard_target='gs://variational_shaker_models/tensorboard/assembly_based_model_prod_daya3',
    checkpoint_directory='gs://variational_shaker_models/checkpoints/assembly_based_model_prod_daya',
    strategy=strategy,
