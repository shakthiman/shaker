...
from protein_folding.variational_model import model_trainer2
...
def main ():
  ...
  model_trainer2.Train(
    ...
    optimizer=optimizer,
    save_frequency=1000,
    write_target='gs://variational_shaker_models/assembly_based_model_prod_ashwam_aggregategrad2',
    tensorboard_target='gs://variational_shaker_models/tensorboard/assembly_based_model_prod_ashwam_aggregategrad2',
    checkpoint_directory='gs://variational_shaker_models/checkpoints/assembly_based_model_prod_ashwam_aggregategrad2',
    strategy=strategy,
